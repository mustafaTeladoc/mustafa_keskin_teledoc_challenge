package TeladocExample.Utilities;
 ...
 * waitForVisibility(WebElement element, int timeToWaitInSec)
 * clickWithJS(WebElement element)
 * waitForClickablility(WebElement element, int timeout)
 * getScreenshot(String name)
 * clickWithWait(WebElement webElement)
 * waitForPageToLoad(long timeOutInSeconds)
 * waitForPageTitle(String pageTitle)
 * getListOfString(List<WebElement> listOfWebElements)
 */
